...
public class EAImageProvider {
	...
	public static List<EAImage> getList(int iFrom, int iTo) {
		...
		while (iFrom <= iTo) {
			String galleryName = cursor
					.getString(cursor
							.getColumnIndexOrThrow(MediaStore.Images.Media.BUCKET_DISPLAY_NAME));
			if ((galleryName == null)
					|| !(galleryName.equalsIgnoreCase("Camera") || !(galleryName.equalsIgnoreCase("DCIM")))) {
			 ...
			 * .getColumnIndexOrThrow(MediaStore.Images.Media.MIME_TYPE)); long
