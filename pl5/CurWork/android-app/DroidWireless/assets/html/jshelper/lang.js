...
function GetLangType() {
	...
	g_CurrentLangType = LANG_INDEX_ENGLISH;
...
function InitLangString() {
	...
	if (ilangType == LANG_INDEX_ENGLISH) {
		...
		sLSysExtAvailableSpace = "Available:";
		sLSysExtTotalSpace = "Total:";
		sLSysAvailRAM = "Available:";
		sLSysTotalRAM = "Total:";
		sLSysBatteryLevel = "Battery:";
		sLSysCpuFreq = "CPU Frequence:";
		sLSysCpuModel = "CPU Model:";

		sLSysRamInfo = "Memory";
		sLSysBatteryInfo = "Battery";
		sLSysSdCardInfo = "External Storage";
		sLSysCpuInfo = "CPU";
